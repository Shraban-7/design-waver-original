                                ...
                                @foreach ($order_packages as $data)
                                    <tr class="text-center">
                                        ...
                                        @php
                                            ...
                                            $endDate = new DateTime($data->packages->offer_price_end_date); // Convert the stored date to a DateTime object

                                           
                                        @endphp
                                        @if ($endDate>=$currentDateTime && $data->packages->offer_package_price!=null )
                                        <td>
