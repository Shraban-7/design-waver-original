...
<section id="whyChooseUs" class="text-gray-600 body-font">
    ...
    <div class="container flex flex-wrap px-6 md:py-12 py-0 mx-auto">
        ...
        <div class="flex flex-col flex-wrap -mb-10 text-center lg:py-6 lg:w-1/2 lg:pl-12 lg:text-left">
            ...
            <div class="flex gap-5 mb-10">
                <div
                    class="2xl:w-16 2xl:h-16 md:w-16 md:h-12 w-[9rem] h-[3.5rem] inline-flex items-center justify-center rounded-full mb-5 bg-orange-100 text-skyBlue ">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
<!-- Service Section  -->
<section id="service" class="p-0 m-0">
  ...
  <div
    ...
    <img
      ...
      src="{{ asset("images/service/service_image/{$service->service_image}") }}"
      alt="" />
  ...
  <div class="p-6">
    <h5
      class="mb-2 text-xl font-medium leading-tight font-space text-neutral-800 hover:text-skyBlue ">
      <a href="{{ route('service_details', $service->slug) }}">{{ $service->service_name }}</a>
    </h5>
    <p class="mb-4 text-base text-neutral-600 font-dm ">
    ...
    <div
        ...
        <div class="flex flex-col mb-32 md:w-1/2">
            <h4 class="text-center md:text-left">ABOUT US</h3>
                <h1 class="flex-1 max-w-6xl text-2xl font-bold text-center font-space md:text-5xl md:text-left mb-10">
                    {{ $page->title }}
                </h1>
