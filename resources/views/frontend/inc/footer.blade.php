        ...
        <div class="flex flex-wrap order-first text-center md:text-left">
            <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                ...
                <div class="md:w-[70%]">
                    ...
                    <p class="container text-[12px] text-center mt-6 md:mx-auto font-dm">Designwaver, a digital design
                ...
                <div
                    ...
                    <a href="https://twitter.com/designwaver" target="_blank" class="text-2xl text-white "><i class="fa-brands fa-x-twitter"></i></a>
