...
<nav class="fixed top-0 z-50 p-6 mx-auto w-full bg-white">
    ...
    <div class="container flex items-center justify-between px-6 mx-auto">
        ...
        <div class="text-2xl">
            <a href="{{ route('home') }}">
                <img class="object-cover h-10" src="{{ asset('front_end/images/website logo.svg') }}" alt="logo" />
            </a>
        </div>
        ...
        <div class="hidden space-x-6 md:flex md:items-center md:justify-between">
            ...
            @else
            <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                class="text-white bg-skyBlue hover:redDark focus:ring-none focus:outline-none font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center"
                type="button">{{ Auth::user()->name }} <svg class="w-4 h-4 ml-2" aria-hidden="true" fill="none"
                    stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7">
                    </path>
