                                                        ...
                                                        <div class="box-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="work_status" class="form-control">
                                                                    ...
                                                                    <option
                                                                        @if ($order->work_status == 'processing') selected @endif
                                                                        value="processing">Processing</option>
                                                                    <option
                                                                        @if ($order->work_status == 'completed') selected @endif
                                                                        value="completed">Completed</option>
                                                                    <option
                                                                        @if ($order->work_status == 'decline') selected @endif
                                                                        value="decline">Decline</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
