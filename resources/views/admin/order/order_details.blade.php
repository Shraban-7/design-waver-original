                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <p>Amarpay TxID: {{ $order->tx_id }}<br>
                                                Payment Processor: {{ $order->payment_processor }}<br>
                                                Payment Type: {{ $order->payment_type }}<br>
                                                Payment Status: @if ($order->payment_status==0)
                                                   <span class="bg-danger px-3 rounded">Un Paid</span> 
                                                    @else
                                                    <span class="bg-success px-3 rounded">Paid</span> 
                                                @endif
                                            </p>
                                        </div>
                                    </div>
