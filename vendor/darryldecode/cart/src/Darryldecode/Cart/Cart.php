...
class Cart
{
     ...
     */
    public function add($id,$service_id = null,$service_name = null, $name = null, $price = null,$main_price=null, $quantity = null, $attributes = array(), $conditions = array(), $associatedModel = null)
    {
        ...
        $data = array(
            ...
            'main_price' => Helpers::normalizePrice($main_price),
            'quantity' => $quantity,
